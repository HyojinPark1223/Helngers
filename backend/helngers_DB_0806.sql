...
-- -----------------------------------------------------
-- Schema Helngers_0806
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema Helngers_0806
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Helngers_0806` DEFAULT CHARACTER SET utf8 ;
USE `Helngers_0806` ;

-- -----------------------------------------------------
-- Table `Helngers_0806`.`medals`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`medals` (
  `id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`challenges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`challenges` (
  `id` BIGINT NOT NULL,
  `title` VARCHAR(45) NOT NULL,
  `content` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`users` (
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`columns`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`columns` (
  `id` BIGINT NOT NULL,
  ...
  CONSTRAINT `column_user_id_to_users_id`
    FOREIGN KEY (`user_id`)
    REFERENCES `Helngers_0806`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`column_like`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`column_like` (
  ...
  CONSTRAINT `column_like_like_target_to_columns_id`
    ...
    REFERENCES `Helngers_0806`.`columns` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`feeds`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`feeds` (
  `id` BIGINT NOT NULL,
  `title` VARCHAR(45) NOT NULL,
  `content` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`feed_files`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`feed_files` (
  `id` BIGINT NOT NULL,
  `url` VARCHAR(300) NULL,
  `feed_id` BIGINT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `feed_files_feed_id_to_feed_id`
    FOREIGN KEY (`feed_id`)
    REFERENCES `Helngers_0806`.`feeds` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`column_comments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`column_comments` (
  `id` BIGINT NOT NULL,
  `content` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`column_files`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`column_files` (
  `id` BIGINT NOT NULL,
  `url` VARCHAR(300) NULL,
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`feed_like`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`feed_like` (
  `like_target` BIGINT NOT NULL,
  `liker` BIGINT NOT NULL,
  PRIMARY KEY (`like_target`),
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`followings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`followings` (
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`challenges_has_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`challenges_has_users` (
  ...
  CONSTRAINT `fk_challenges_has_users_challenges1`
    ...
    REFERENCES `Helngers_0806`.`challenges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`feed_comments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`feed_comments` (
  `id` BIGINT NOT NULL,
  `content` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `Helngers_0806`.`medals_has_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Helngers_0806`.`medals_has_users` (
  ...
  CONSTRAINT `fk_medals_has_users_medals1`
    ...
    REFERENCES `Helngers_0806`.`medals` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
